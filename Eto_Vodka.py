...
elif order != "hot chocolate" or "tea" or "coffee":
    print("(Barista): Nope, we don't serve that.")
    exit()
...
elif payment_method == "Ohio":
    print("https://open.spotify.com/track/7o8cvobGNd2IbhCz7J0DvB?si=eff1a02dbe074d80")

else:
    print(f"(Barista): Sorry, we don't accept that. Buuuuuuuuuuuuuuuuuuuuuut, you're getting them for free, {name}. You lucky son of a bi- [You leave at the right moment.]")
time.sleep(2.3712659852) #Very Specific
print(f"[You reach home. You drink your{order}(s) in peace. What a vibe.]")
time.sleep(3.1415926535897932384626433)
print("[What a vibe.]")
time.sleep(3)